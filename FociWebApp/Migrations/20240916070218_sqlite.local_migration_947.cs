...
{
    /// <inheritdoc />
    public partial class sqlitelocal_migration_947 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VegndegVeg = table.Column<int>(type: "INTEGER", nullable: false),
                    HazaigFelido = table.Column<int>(type: "INTEGER", nullable: false),
